...
export function Root() {
    return (
        <html lang="en">
            ...
            <body>
                <svg class="logo" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 200" width="42" height="42" aria-label="Scratch Logo">
                ...
                <main>
                    ...
                    <section class="getting-started">
                        ...
                        <pre>
                            <code>curl -Lo scratch.ts https://s.iamb.dev</code>
                        </pre>
                    ...
                    <section class="how-it-works">
                        <h2>How it works</h2>
                        <p>
                            JSX in <code>src/</code> renders to raw HTML strings at build time. Client JS and CSS are
                            inlined, assets are copied, and everything ships as a single file.
                        </p>
                        <div class="arch">
                            <div class="arch-rows">
                                <div class="arch-row">
                                    <div class="arch-inputs">
                                        <div class="arch-file">
                                            ...
                                            <span class="arch-file-desc">JSX components rendered to raw HTML at build time</span>
                                        </div>
                                        <div class="arch-file">
                                            <span class="arch-file-name">src/client.ts</span>
                                            <span class="arch-file-desc">TypeScript compiled to browser-optimized JavaScript</span>
                                        </div>
                                        <div class="arch-file">
                                            <span class="arch-file-name">src/style.css</span>
                                            <span class="arch-file-desc">Styles minified and bundled for the browser</span>
                                        </div>
                                    </div>
                                    <span class="arch-arrow">→</span>
                                    <div class="arch-output">
                                        <span class="arch-output-name">dist/index.html</span>
                                        <span class="arch-output-desc">Single file — HTML, CSS, and JS all in one</span>
                                    </div>
                                </div>
                                <div class="arch-row">
                                    <div class="arch-inputs">
                                        <div class="arch-file arch-file--assets">
                                            ...
                                            <span class="arch-file-desc">Images, fonts, and SVGs served as static files</span>
                                        </div>
                                    </div>
                                    <span class="arch-arrow">→</span>
                                    <div class="arch-output arch-output--copy">
                                        <span class="arch-output-name">dist/</span>
                                        <span class="arch-output-desc">Copied as-is with paths preserved</span>
                                    </div>
                                </div>
                            </div>
                        </div>
