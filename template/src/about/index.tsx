            ...
            <div class="center">
                ...
                <div class="prose">
                    <p>
                        ...
                        stack of Vite plus React plus TypeScript plus a pile of config to be total
                        overkill. I didn't need a virtual DOM, client-side routing, or a hydration
                        step. I just wanted to write some markup, get a few interactive bits, and
                        ship plain HTML.
                    </p>
                    <br />
                    <p>
                    ...
                    <p>
                        ...
                        <a href="https://iambrian.com" target="_blank" rel="noopener noreferrer">
                            my personal site
                        </a>
                    ...
                    <ul>
                        ...
                        <li>An optional assets directory copied straight through to the output</li>
                    </ul>
                    <h2>Why</h2>
                    <p>
                        Most prototypes don't need a bundler or a component framework. Skrapa keeps
                        the authoring ergonomics of JSX while shipping nothing but the HTML, CSS,
                        and JS you actually wrote.
                    </p>
                    <h2>Getting started</h2>
                    <ul>
                        <li>
                            <code>npx skrapa init</code> scaffolds a new project
                        </li>
                        <li>
                            <code>npx skrapa dev</code> starts the dev server with live reload
                        </li>
                        <li>
                            <code>npx skrapa build</code> builds the static site once
                        </li>
                    </ul>
                </div>
                <p class="sub">
